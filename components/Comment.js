...
export default class Comment extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="comment" ref={el => { this.dom = el }}>
                <div>
                    <div className="meta">
                ...
                </div>
                {
                    this.state.editClicked
                        ?
                        <div className="form">
                            <textarea id="comment" onChange={this.handleChange.bind(this)} ref={el => { this.textarea = el; }} value={this.state.comment}>{comment}</textarea>
                            <div className="save-btn">
                                <button onKeyUp={this.handleKeyUp.bind(this)}>
                                    <i onClick={this.editComment.bind(this)} className="icon-floppy" />
                                </button>
                            </div>
                        </div>

                        :
                        <div className="content" ><pre>{comment}</pre></div>
                }
